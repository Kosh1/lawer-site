  ...
  const steps = [
    {
      ...
      description: "Расскажите о проблеме обычными словами",
      color: "text-blue-600",
      bgColor: "bg-blue-100",
    },
    {
      id: 2,
      icon: Brain,
      title: "ИИ СОЗДАСТ ДОКУМЕНТ",
      description: "Нейросеть проанализирует и составит иск",
    ...
    },
    {
      id: 3,
      icon: Download,
      title: "СКАЧАЙТЕ ГОТОВЫЙ ИСК",
      description: "Получите документ в формате Word или PDF",
